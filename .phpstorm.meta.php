...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\laragon\www\laravel-bbs\public\storage' => 'string',
...
'app.providers','app.aliases.Captcha','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'cache.stores.octane.driver','cache.prefix','captcha.disable','captcha.characters','captcha.default.length',
'captcha.default.width','captcha.default.height','captcha.default.quality','captcha.default.math','captcha.default.expire',
'captcha.default.encrypt','captcha.math.length','captcha.math.width','captcha.math.height','captcha.math.quality',
'captcha.math.math','captcha.flat.length','captcha.flat.width','captcha.flat.height','captcha.flat.quality',
'captcha.flat.lines','captcha.flat.bgImage','captcha.flat.bgColor','captcha.flat.fontColors','captcha.flat.contrast',
'captcha.mini.length','captcha.mini.width','captcha.mini.height','captcha.inverse.length','captcha.inverse.width',
'captcha.inverse.height','captcha.inverse.quality','captcha.inverse.sensitive','captcha.inverse.angle','captcha.inverse.sharpen',
'captcha.inverse.blur','captcha.inverse.invert','captcha.inverse.contrast','database.default','database.connections.sqlite.driver',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\laragon\\www\\laravel-bbs\\public\\storage',
...
'web','api',);
        registerArgumentsSet('routes', 'root','login','logout','register','password.request',
'password.email','password.reset','password.update','password.confirm',
'verification.notice','verification.verify','verification.resend','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','layouts._footer','layouts._header','layouts.app','pages.root',
'shared._messages','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'validation.attributes.work','validation.attributes.year','ja.0','actions.accept','actions.action',
